...
A cross-cell landscape synthesis was added on 2026-08-03 (research/2026-08-landscape-synthesis.md): the nine discovery cycles converted into seven cross-cutting currents, the contested-claims ledger (C-OSA-01..04) re-scored with provisional verdicts, and the gap queue re-ranked by what would change the synthesis most. The collection itself was unchanged by the synthesis pass. The same day, the OADA record (the queue's first item, hinge for C-OSA-01) was verified in depth: active Purdue OATS-maintained reference server (commits 2026-08-01) against an absent adoption layer — no verified OADA-compliant implementations or farmer-facing deployments, with ADC/NAPDC explicitly disclaiming OADA as its storage layer (research/2026-08-oada-implementation-scan.md).
