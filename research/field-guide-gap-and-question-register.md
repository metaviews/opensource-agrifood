...
Re-ranked 2026-08-03 by the landscape synthesis (research/2026-08-landscape-synthesis.md) on one criterion: which gap, resolved, would change the synthesis most. G-OSA-01 (OADA), G-OSA-20 (SAOS/GISC), and the local-language cycle (G-OSA-19 partially; G-OSA-15 residual) were resolved or advanced by verification scans on 2026-08-03.

1. G-OSA-03 / Q-OSA-10: concrete Common Voice agrifood applications — hinge for C-OSA-03.
2. G-OSA-21: OSSL enforcement and uptake — track-only (no public court record; re-check annually).
3. G-OADA-02: AGAPECert / Mask & Link status under ADC — track with the NAPDC follow-up (G-OSA-20 residual).
4. G-DC-04: Scottish Agriculture Data Partnership details — track when Scottish sources publish governance details.
5. G-LL-01: Chinese maker-media open-design cases (zhihu tractor) — verify identity/licence/farmer status, ideally via WeChat/Douyin sources.
