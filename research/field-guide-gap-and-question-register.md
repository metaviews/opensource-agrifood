...
2. Fieldwork-bound (not public-source cycles): G-OSA-18 (farmer agency in practice — the project's central question), G-OSA-02 (JoinData membership — org request), G-OSA-08 residual (~15 unverified maintenance statuses), G-GS-05 residual (farmer-led licensed Global South hardware — field verification).
