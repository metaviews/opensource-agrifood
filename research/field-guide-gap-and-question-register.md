...
| G-OSA-15 | Global South open agrifood hardware | Cost barriers to commercial equipment are highest where open designs would be cheapest entry points | 2026-08-02 pass: Think Oggún (open-manufacturing transfer), Flying Labs Network (~40 countries), AfricaOSH, REGOSH (Argentina); contrast case PAIS Kit (Brazil) is affordable but closed | Remaining sub-gap: farm-level open hardware with public design files in the Global South (G-GS-01); Asia-Pacific not yet searched | Partially addressed (2026-08-02 pass; network and transfer layers located, farm-level hardware remains thin) |
