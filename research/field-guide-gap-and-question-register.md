...
Re-ranked 2026-08-03 by the landscape synthesis (research/2026-08-landscape-synthesis.md) on one criterion: which gap, resolved, would change the synthesis most. G-OSA-01 (OADA) and G-OSA-20 (SAOS/GISC follow-up) were resolved by verification scans on 2026-08-03.

1. Local-language cycle (Spanish, Portuguese, French, Hindi) targeting G-GS-05 (confirmed-absence finding is English-language only) and G-OSA-19 (China implementation).
2. G-OSA-03 / Q-OSA-10: concrete Common Voice agrifood applications — hinge for C-OSA-03.
3. G-OSA-21: OSSL enforcement and uptake — downgraded to track-only (no public court record; re-check annually).
4. G-OADA-02: AGAPECert / Mask & Link status under ADC — track with the NAPDC follow-up (G-OSA-20 residual).
5. G-DC-04: Scottish Agriculture Data Partnership details — track when Scottish sources publish governance details.
