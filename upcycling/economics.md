...
| Facility | Where capacity comes from — rented hours, a second-generation food space, a modular unit, a community or co-op facility, or contract processing at a co-packer (no facility at all) — **not a procurement decision for one operator**. An approved commercial premises is required in every case where the operation processes itself, since the home-kitchen route does not cover preserves | **Partly sourced, and reframed twice**: first as a sequencing question, then (user direction, 2026-09-11) as a capacity question rather than an acquisition question. Verified Ontario hourly rates ($22–38.50/hr at a preserves-equipped Toronto facility), a published Toronto suite at $3,500/month all-in, and break-even at ≈91–159 production hours a month. Co-packing — the zero-facility route — is unpriced. Build-out and second-generation space remain unpriced. See `research/kitchen-mvp-and-shared-infrastructure.md` |
