...
| Facility | Rented certified kitchen hours, a second-generation food space, a modular container unit, or a build-out — **an approved commercial premises in every case**, since the home-kitchen route does not cover preserves | **Partly sourced, and reframed as a sequencing question** — verified Ontario hourly rates ($22–38.50/hr at a preserves-equipped Toronto facility), a published Toronto suite at $3,500/month all-in, and the arithmetic that puts break-even at ≈91–159 production hours a month. Build-out and second-generation space remain unpriced. See `research/kitchen-mvp-and-shared-infrastructure.md` |
