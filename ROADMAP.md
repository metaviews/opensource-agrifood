...
|---|---|---|---|
| Research corpus | Discovery programme complete; 109 records; synthesis v3; register at G-OSA-35 (land scan + verification complete 2026-09-04); G-OSA-33/34 complete; grocery records folded in | `research/2026-08-landscape-synthesis-v3.md`, `research/2026-08-processing-sectoral-scan.md`, `research/field-guide-gap-and-question-register.md` | 2026-09-02 |
