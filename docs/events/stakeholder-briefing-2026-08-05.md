...
- **Session 2 — *what*.** *Intelligence begins on the farm and in the food.* The live terrain of open-source AI in Canadian agrifood: what's actually being deployed, what's real, what isn't, what's at stake.
- **Session 3 — *how*.** *Emergency preparedness through theatre games.* A role-play that lets the room inhabit the contested terrain. Dramaturgical, with edutainment and memorability at its core.
