...
Format: online, Discord, half-day, four sessions, summit-shaped with salon texture
Outputs: byproducts of an experience; the experience itself is the deliverable

## Event identity (settled)

**Title:** *Building the Open-Source Future of Canadian Agrifood*
**Subtitle:** *A Future Herd spectacular event on AI and agrifood*
...
ACME and SAM are the **process discipline** — implicit in how the event runs, never announced as a frame.

## Sources of truth — what's actually in the corpus

### future-herd/ — the editorial record

36 episodes and 36 knowledge pieces. The Future Herd's editorial centre of gravity is *Canadian* agrifood system analysis with attention to power, history, equity, and the food side of the value chain. The event inherits that centre of gravity.
...
58 verified records, three-axis landscape synthesis v2 with seven currents (farmer-maker, state DPI, open-core + paid services, commons without licences, donor-funded farmer-centric, Global South trust-and-transfer, regulation-as-access). Headline finding: openness is layered, the layers decouple, and farmer agency is the scarcest layer. Useful as one specific lens for the event; not authoritative for the event as a whole.

## Frames the event will be in conversation with

These are the substantive frames already present in the corpus. The event doesn't need to invent them — it inherits them.
...
**The event will *not* be well-served by:**
...
**What this suggests about the event shape (not locked):**

The event needs *enough structure to be generative* but *enough openness that the dissent and surprise can happen*. The Future Herd pattern is editorial structure that lets the conversation go where it needs to go. The event inherits that posture: themes, not agendas.
...
## The four claims (working draft, future-herd voice)

The event is organised around a logic of inquiry: **who → what → how → when**. Each session is held together by a claim — a textured proposition about what the room encounters. These are working drafts of the room's interior, not titles.

### Session 1 — *who*: The room's first work is the people in it
**Title:** *Power goes to those who show up ready to do something*

**The claim:** *This event's first work is the people in it. We honor what they bring and what they want to learn. Curiosity is substance here. The room is theirs to lead or to follow.*

The room encounters itself — not as a designed composition to inspect, but as a gathering of people whose presence is the event's first commitment. This session's facilitation is question-work, not moderation-work: *who are you, what do you bring, what do you want to learn, what would you like this room to be* — asked in a way that treats curiosity and knowledge as equally worthy. Some people arrive with substance to contribute; some arrive with attention to give; both are honored. The session does not analyze the sector's composition problem; it recognizes the room as it is. The future *who* of the event grows through the people in it — through who existing participants bring, not through abstract recruitment.

Inherited from: Episode 10 (Jamie Reaume on the sector talking to itself — reframed: the session honors the room that shows up, not the room that should); Episode 33 (Tianna Brand on meeting people where their futures already are); the future-herd pattern of treating guests as full participants whose curiosity is as substantive as their expertise; the ACME cell-formation practice of care check-ins as the first beat of every gathering.

### Session 2 — *what*: The current state of open-source AI in Canadian agrifood, and why it matters now
**Title:** *Intelligence begins on the farm and in the food*
...
The room encounters the live terrain: edge computing and dark data, the energy arithmetic of agricultural AI, the OEM question, the decision-support framing that relocates AI inside existing decisions rather than treating it as replacement. The texture is concrete and current-affairs-loaded — agentic computing as one enabler among several, but the focal point right now because it is reshaping what's possible fastest. Open-source AI is one of the architectural choices being made in real time, and the choices being made now will shape who benefits and who doesn't. The room looks at what's actually being deployed, what's real, what isn't, and what's at stake for the people whose knowledge is in play. Because the people in the room have already been encountered in session 1, the *what* session's material is partly already present — researchers describe what they're working on, farmers describe what they're seeing, technologists describe what they're building. The session deepens rather than opens.
